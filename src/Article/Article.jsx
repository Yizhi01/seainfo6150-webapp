  ...
  return (
    <div>
      <div>
        ...
        <p>
          <em>by Kate Farley (<a href="mailto:kate.farley@nytimes.com)">kate.farley@nytimes.com)</a></em><br/>
          November 22, 2018
        </p>
      ...
      <div>
        ...
        <p>
          Not only is the Statue of Liberty the symbol of New York City, she is also a UNESCO World Heritage site under the designation of <span><em>Outstanding Universal Value</em></span>.
        </p>
        <p>
        ...
        <blockquote>
          "Give me your tired, your poor<br/>Your huddled masses yearning to breathe free."
        </blockquote>
        <p>
      ...
      <div>
        ...
        <ul>
          <li>
            Total overall height from the base of the pedestal foundation to the tip of the torch is <span><b>305 feet, 6 inches</b></span>
          </li>
          <li>
            Height of the Statue from her heel to the top of her head is 111 feet, 6 inches
          </li>
          <li>
            The Statue has a <span><b>35-foot</b></span> waistline
          </li>
          <li>
            Total weight of the Statue of Liberty is <span><b>225 tons (or 450,000 pounds)</b></span>
          </li>
        </ul>
      </div>
